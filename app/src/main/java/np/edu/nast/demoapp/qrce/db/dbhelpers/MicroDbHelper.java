...
public class MicroDbHelper extends SQLiteOpenHelper {
    ...
    private static final String Database_name = "microprocessor.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "microprocessor";//name of table
    ...
    public MicroDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {MicroDbHelper._ID, MicroDbHelper.COLUMN_QUESTION};
