 ...
 */
public class OOPInCPPDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "oop_in_cpp.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "oop_in_cpp";//name of table
    ...
    public OOPInCPPDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {OOPInCPPDbHelper._ID, OOPInCPPDbHelper.COLUMN_QUESTION};
