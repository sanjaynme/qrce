 ...
 */
public class NEADbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "nea.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "nea";//name of table
    ...
    public NEADbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {NEADbHelper._ID, NEADbHelper.COLUMN_QUESTION};
