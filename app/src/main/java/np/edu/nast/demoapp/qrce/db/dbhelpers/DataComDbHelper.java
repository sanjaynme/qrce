 ...
 */
public class DataComDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "data_communication.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "data_communication";//name of table
    ...
    public DataComDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {DataComDbHelper._ID, DataComDbHelper.COLUMN_QUESTION};
