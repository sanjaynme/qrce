...
public class SMDbHelper extends SQLiteOpenHelper {
    ...
    private static final String Database_name = "simulation_and_modeling.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "simulation_and_modeling";//name of table
    ...
    public SMDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {SMDbHelper._ID, SMDbHelper.COLUMN_QUESTION};
