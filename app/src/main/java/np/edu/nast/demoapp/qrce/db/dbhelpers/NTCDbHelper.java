 ...
 */
public class NTCDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "ntc.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "ntc";//name of table
    ...
    public NTCDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {NTCDbHelper._ID, NTCDbHelper.COLUMN_QUESTION};
