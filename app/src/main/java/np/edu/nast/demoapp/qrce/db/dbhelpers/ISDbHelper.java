 ...
 */
public class ISDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "information_system.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "information_system";//name of table
    ...
    public ISDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {ISDbHelper._ID, ISDbHelper.COLUMN_QUESTION};
