...
public class CGDbHelper extends SQLiteOpenHelper {
    ...
    private static final String Database_name = "CG.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "CG";//name of table
    ...
    public CGDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {CGDbHelper._ID, CGDbHelper.COLUMN_QUESTION};
