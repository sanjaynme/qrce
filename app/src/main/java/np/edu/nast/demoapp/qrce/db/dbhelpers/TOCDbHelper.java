 ...
 */
public class TOCDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "theory_of_computation.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "theory_of_computation";//name of table
    ...
    public TOCDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {TOCDbHelper._ID, TOCDbHelper.COLUMN_QUESTION};
