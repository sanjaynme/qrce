 ...
 */
public class DSADbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "dsa.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "dsa";//name of table
    ...
    public DSADbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {DSADbHelper._ID, DSADbHelper.COLUMN_QUESTION};
