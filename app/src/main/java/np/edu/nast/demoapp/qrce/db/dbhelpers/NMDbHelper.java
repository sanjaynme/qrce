 ...
 */
public class NMDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "numerical_methods.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "numerical_methods";//name of table
    ...
    public NMDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {NMDbHelper._ID, NMDbHelper.COLUMN_QUESTION};
