...
public class CNDbHelper extends SQLiteOpenHelper {
    ...
    private static final String Database_name = "computer_network.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "computer_network";//name of table
    ...
    public CNDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {CNDbHelper._ID, CNDbHelper.COLUMN_QUESTION};
