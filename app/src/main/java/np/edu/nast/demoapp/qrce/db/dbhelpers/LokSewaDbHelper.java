 ...
 */
public class LokSewaDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "loksewa.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "loksewa";//name of table
    ...
    public LokSewaDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {LokSewaDbHelper._ID, LokSewaDbHelper.COLUMN_QUESTION};
