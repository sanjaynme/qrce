 ...
 */
public class CSharpDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "c_sharp.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "c_sharp";//name of table
    ...
    public CSharpDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {CSharpDbHelper._ID, CSharpDbHelper.COLUMN_QUESTION};
