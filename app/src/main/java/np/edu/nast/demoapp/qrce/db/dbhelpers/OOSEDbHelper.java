 ...
 */
public class OOSEDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "oose.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "oose";//name of table
    ...
    public OOSEDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {OOSEDbHelper._ID, OOSEDbHelper.COLUMN_QUESTION};
