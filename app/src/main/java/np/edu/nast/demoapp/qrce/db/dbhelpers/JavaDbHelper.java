...
public class JavaDbHelper extends SQLiteOpenHelper {
    ...
    private static final String Database_name = "java.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "java";//name of table
    ...
    public JavaDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {JavaDbHelper._ID, JavaDbHelper.COLUMN_QUESTION};
