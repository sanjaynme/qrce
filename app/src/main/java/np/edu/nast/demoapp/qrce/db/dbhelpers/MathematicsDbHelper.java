 ...
 */
public class MathematicsDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "mathematics.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "mathematics";//name of table
    ...
    public MathematicsDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {MathematicsDbHelper._ID, MathematicsDbHelper.COLUMN_QUESTION};
