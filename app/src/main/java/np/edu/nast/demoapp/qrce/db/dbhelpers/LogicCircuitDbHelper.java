 ...
 */
public class LogicCircuitDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "logic_circuits.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "logic_circuits";//name of table
    ...
    public LogicCircuitDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {LogicCircuitDbHelper._ID, LogicCircuitDbHelper.COLUMN_QUESTION};
