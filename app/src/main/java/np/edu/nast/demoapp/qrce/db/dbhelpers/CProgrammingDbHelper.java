 ...
 */
public class CProgrammingDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "c_programming.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "programming_in_c";//name of table
    ...
    public CProgrammingDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {CProgrammingDbHelper._ID, CProgrammingDbHelper.COLUMN_QUESTION};
