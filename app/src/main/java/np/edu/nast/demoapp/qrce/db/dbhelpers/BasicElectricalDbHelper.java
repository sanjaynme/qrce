 ...
 */
public class BasicElectricalDbHelper extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/np.edu.nast.demoapp.qrce/databases/";
    private static final String Database_name = "basic_electrical.db";//NAME of database stored in Assets folder
    public static final String TABLE_NAME = "basic_electrical";//name of table
    ...
    public BasicElectricalDbHelper(Context context) {//constructor
    ...
    public String readQuestion(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String[] columns = {BasicElectricalDbHelper._ID, BasicElectricalDbHelper.COLUMN_QUESTION};
